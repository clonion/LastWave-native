...
/**
 * Apple-style redesign: same bundled Google Sans Flex variable font as
 * before (res/font/google_sans_flex.ttf), now tuned to sit as close to
 * SF Pro's proportions as this font's axes allow — rounded terminals
 * (ROND up) and the font's default width, replacing the flat/engineered
 * 0-ROND tuning from the Nothing OS look. Weight is still varied for
 * hierarchy; that's structural, not decorative.
 */
private fun gsFlex(
    weight: Float,
    opticalSize: Float,
...
val LastWaveTypography = Typography(
    ...
    headlineLarge = TextStyle(fontFamily = gsFlex(700f, 30f), fontWeight = FontWeight.Bold, fontSize = 30.sp, lineHeight = 38.sp, letterSpacing = 0.sp),
    headlineMedium = TextStyle(fontFamily = gsFlex(700f, 26f), fontWeight = FontWeight.Bold, fontSize = 26.sp, lineHeight = 34.sp, letterSpacing = 0.sp),
    headlineSmall = TextStyle(fontFamily = gsFlex(600f, 22f), fontWeight = FontWeight.SemiBold, fontSize = 22.sp, lineHeight = 30.sp, letterSpacing = 0.sp),
    titleLarge = TextStyle(fontFamily = gsFlex(600f, 19f), fontWeight = FontWeight.SemiBold, fontSize = 19.sp, lineHeight = 26.sp, letterSpacing = 0.sp),
    titleMedium = TextStyle(fontFamily = gsFlex(500f, 15f), fontWeight = FontWeight.Medium, fontSize = 15.sp, lineHeight = 22.sp, letterSpacing = 0.sp),
    titleSmall = TextStyle(fontFamily = gsFlex(500f, 13f), fontWeight = FontWeight.Medium, fontSize = 13.sp, lineHeight = 18.sp, letterSpacing = 0.sp),
    bodyLarge = TextStyle(fontFamily = gsFlex(400f, 14f), fontWeight = FontWeight.Normal, fontSize = 14.sp, lineHeight = 22.sp),
    bodyMedium = TextStyle(fontFamily = gsFlex(400f, 13f), fontWeight = FontWeight.Normal, fontSize = 13.sp, lineHeight = 20.sp),
    bodySmall = TextStyle(fontFamily = gsFlex(400f, 12f), fontWeight = FontWeight.Normal, fontSize = 12.sp, lineHeight = 18.sp),
    // Apple-style section headers: sentence case, not the tracked-out
    // uppercase "stenciled hardware label" look from the Nothing OS type
    // scale — tracking pulled back in close to system defaults.
    labelLarge = TextStyle(fontFamily = gsFlex(600f, 13f), fontWeight = FontWeight.SemiBold, fontSize = 13.sp, lineHeight = 20.sp, letterSpacing = 0.1.sp),
    labelMedium = TextStyle(fontFamily = gsFlex(600f, 11f), fontWeight = FontWeight.SemiBold, fontSize = 11.sp, lineHeight = 16.sp, letterSpacing = 0.2.sp),
    labelSmall = TextStyle(fontFamily = gsFlex(500f, 10f), fontWeight = FontWeight.Medium, fontSize = 10.sp, lineHeight = 16.sp, letterSpacing = 0.2.sp),
)

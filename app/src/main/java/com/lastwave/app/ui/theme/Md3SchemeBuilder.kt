...
object Md3SchemeBuilder {
    ...
    /**
     * Apple-style scheme: white/near-white surfaces, black ink text, and a
     * single iOS-blue accent — replacing the Nothing OS monochrome+red
     * scheme above. No hue-derived tonal roles here (Apple's system palette
     * isn't hue-seeded); every role is a fixed, named value instead.
     */
    fun buildAppleLightScheme(): ColorScheme = lightColorScheme(
        primary = Color(0xFF0A84FF),
        onPrimary = Color.White,
        primaryContainer = Color(0xFFD8E9FF),
        onPrimaryContainer = Color(0xFF04315E),
        ...
        tertiaryContainer = Color(0xFFDCF7E3),
        onTertiaryContainer = Color(0xFF0B3A17),

        error = Color(0xFFFF3B30),
        onError = Color.White,
        errorContainer = Color(0xFFFFE0DE),
        onErrorContainer = Color(0xFF5C0B06),
        ...
        inversePrimary = Color(0xFF6EB4FF),
        scrim = Color.Black,
    )
